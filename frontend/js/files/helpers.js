...
const FILE_ICON_MAP = Object.freeze({
  ...
  ts: {
    src: "assets/file-icons/ts.svg",
    cls: "file-icon-ts",
    alt: "TypeScript file icon",
  },
  tsx: {
    src: "assets/file-icons/ts.svg",
    cls: "file-icon-ts",
  ...
  py: {
    src: "assets/file-icons/python.svg",
    cls: "file-icon-py",
    alt: "Python file icon",
  },
  java: {
    src: "assets/file-icons/java.svg",
    cls: "file-icon-java",
    alt: "Java file icon",
  },
  cs: {
    src: "assets/file-icons/csharp.svg",
    cls: "file-icon-cs",
    alt: "C sharp file icon",
  },
  cpp: {
    src: "assets/file-icons/cpp.svg",
    cls: "file-icon-cpp",
    alt: "C plus plus file icon",
  },
  cc: {
    src: "assets/file-icons/cpp.svg",
    cls: "file-icon-cpp",
  ...
  go: {
    src: "assets/file-icons/go.svg",
    cls: "file-icon-go",
    alt: "Go file icon",
  },
  rs: {
    src: "assets/file-icons/rust.svg",
    cls: "file-icon-rs",
    alt: "Rust file icon",
  },
});
